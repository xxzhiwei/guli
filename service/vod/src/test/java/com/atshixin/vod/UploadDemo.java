...
public class UploadDemo {
    //账号AK信息（必选）
    private static final String accessKeyId = "LTAIiE5h3p4dOZAP";
    //账号AK信息（必选）
    private static final String accessKeySecret = "5N04xP7NqdYAcc2nsJjYwcopx4Kn7P";
    ...
    public static void main(String[] args) {
        ...
        //文件名必须包含扩展名
        String fileName = "/Users/xieshixin/Downloads/29fd34ba6b7c69d904552c1ad396cdf01594213386.mp4";
        //本地文件上传
